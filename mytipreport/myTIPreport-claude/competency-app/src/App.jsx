  ...
  return (
    <div>
      <div style={{ marginBottom: 20 }}>
        ...
        <div style={{ fontSize: 12, color: tokens.colors.textMuted, marginTop: 6, maxWidth: 560, lineHeight: 1.5 }}>
          One learner's feedback grouped by competency, with evidence trends and sufficiency — flagging where the record is too thin to draw conclusions.
        </div>
      </div>
  ...
  return (
    <div>
      <div style={{ marginBottom: 20 }}>
        ...
        <div style={{ fontSize: 12, color: tokens.colors.textMuted, marginTop: 6, maxWidth: 560, lineHeight: 1.5 }}>
          Confirm or reassign the AI-suggested competency for each new comment — low-confidence suggestions must be verified before they count as evidence.
        </div>
      </div>
    ...
    <div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 20, flexWrap: "wrap", gap: 12 }}>
        <div>
          ...
          <div style={{ fontSize: 12, color: tokens.colors.textMuted, marginTop: 6, maxWidth: 560, lineHeight: 1.5 }}>
            A program-wide roster of each learner's overall evidence sufficiency and count of thin-evidence competencies, so directors can spot coverage gaps.
          </div>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
